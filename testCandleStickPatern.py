...
# positive, negative = resultTester.test_next_day_opening_price(stock_opening, stock_closing, lhv_index)

# drawCandle.draw_candle_stick_with_saved_data(stock_n, 581, drawCandle.show_test_result, (positive, negative), "L")
drawCandle.draw_candle_stick(stock_n, date1, date2, drawCandle.show_result, lhv_con_index, "L")
