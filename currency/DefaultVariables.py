...
#color
NEWTRADE_BUTTON = (252, 119, 3)
UP_BUTTON_COLOR = (44, 172, 64)
UP_BUTTON_COLOR2 = (41, 138, 62)
DOWN_BUTTON_COLOR = (219, 73, 49)

#trading

SECOND_TRADE_ADVANTAGE_RATE = 0.03
MINUTE_MAX_SIDE_TRADE = 8
MAX_TRADE_SECOND_INTERVAL = 3
FIRST_X_SECONDS_IN_A_MINUTE_NO_TRADE = 5